...
import { ArrowUpRight, ArrowDownRight, DollarSign, PieChart, Activity } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ data, onReset }) => {
    // Prepare chart data
    // Group profits by date for the chart
    ...
    const formatCurrency = (val: number) => {
        return new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(val); // Assuming USD for now or mixed
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="card border-l-4 border-l-purple-500">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-gray-400 text-sm">Total Fees Paid</span>
                    </div>
                    <div className="text-3xl font-bold text-white">
